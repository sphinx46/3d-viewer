...
public final class MessageConstants {
    ...
    public static final String MODEL_SAVE_SUCCESS = "Модель успешно сохранена";

    public static final String EMPTY_OBJECT_CREATED = "Пустой объект создан";
    public static final String EMPTY_OBJECT_DETAILS = "Создан новый куб для редактирования";
    public static final String OBJECT_SAVED = "Объект сохранен";
    ...
    public static final String SCENE_LOAD_SUCCESS = "Сцена успешно загружена";
    public static final String SCENE_SAVE_SUCCESS = "Сцена успешно сохранена";
